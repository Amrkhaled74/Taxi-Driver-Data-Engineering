...
---
1. [Infrastructure Overview](#infrastructure)
2. [Purpose of SQL Scripts](#purpose)
3. [How to Apply](#apply)
4. [Data Loading Strategy](#strategy)

---

## <a name="infrastructure"></a>🏗️ Infrastructure Overview
